...
from core.constants import PROJECT_PATH_NAME, EXPORT_FOLDER_PATH
...
def get_relative_folder_path(path: Path, base_folder: str = PROJECT_PATH_NAME) -> Path:
    try:
        # Encontra o índice da pasta 'data' no caminho e retorna o caminho relativo a partir de 'data'
